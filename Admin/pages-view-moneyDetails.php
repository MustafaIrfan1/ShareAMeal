        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="m-b-20">
                            <h5 class="font-14"><b>Money Donation Table</b></h5>
                            <table class="table table table-hover table-bordered">
                                ...
                                $result = mysqli_query($db, "SELECT * FROM moneys WHERE UserID='$myUser_id'");

                                while ($row = mysqli_fetch_array($result)) {

                                    ?>
                                    <tr>
                                        <td scope="row" class="text-center"><?php echo $row['MoneyID'] ?></td>
